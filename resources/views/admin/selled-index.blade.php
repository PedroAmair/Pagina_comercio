                                            ...
                                            @foreach ($value->payments as $voucher)
                                                <div>
                                                    <a 
                                                        ...
                                                        class="text-sky-800 hover:text-black flex flex-col items-center"
                                                    >
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6 w-12 md:w-8">
                                                ...
                                                <button type="submit">
                                                    @foreach ($value->payments as $checkStatus)
                                                        @if ($checkStatus->pivot->status === 0)
                                                            <div class="text-green-700 hover:text-black flex flex-col items-center">
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6 w-12 md:w-8">
                                                        ...
                                                        @else
                                                            <div class="text-red-700 hover:text-black flex flex-col items-center">
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 w-12 md:w-8">
