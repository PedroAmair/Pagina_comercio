    ...
    <div class="flex flex-col md:flex-row items-center gap-5 m-5">
        ...
        <div class="w-full md:w-6/12">
            ...
            <div class="border-2 border-solid border-gray-200 flex flex-col 2xl:flex-row justify-center items-center py-2 2xl:py-0">
                ...
                <a href="{{route('selled.index', auth()->user()->username)}}" class="p-5 font-bold bg-gray-200 hover:bg-gray-300 rounded-full w-2/3 lg:w-2/4 2xl:w-full my-2 2xl:my-5 2xl:mx-2 text-center">My sales</a>
            </div>
        </div>
