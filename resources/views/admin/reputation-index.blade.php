...
@section('content')
            ...
            <div class="w-11/12 border-2 border-solid border-gray-200 my-5 mx-auto p-2 shadow-md">
                <div class="flex justify-between items-center rounded-lg bg-gray-300 p-2">
                    <div class="flex items-center gap-1">
                        <div><img class="w-10 h-10 rounded-full" src="{{asset('uploads/profilePhotos').'/'.$rate->user->image}}" /></div>
                        <div class="font-bold text-lg">{{ucfirst($rate->user->username)}}</div>
                    </div>

                    <div>
                        <p class="font-bold">{{$rate->created_at->diffForHumans()}}</p>
                    </div>
                </div>
                <div class="flex items-center mt-2">
                    @if($rate->calification == 5)
    ...
    @else
        <div class="flex flex-col items-center">
            <div>
                <p class="mt-[10%] uppercase text-4xl text-gray-200">you have no qualifications!</p>
            </div>
        </div
    @endif
@endsection