        ...
        @foreach ($processors as $processor)
            <div class="min-w-[25%] md:min-w-[20%] lg:min-w-[17%] xl:min-w-[12%]">
                <a href="{{route('searchs.show', $processor->id)}}">
                    ...
                    <p class="truncate text-center font-bold 2xl:text-xl">{{$processor->brand === 'amd' ? strtoupper($processor->brand).' '.$processor->product :  ucfirst($processor->brand).' '.$processor->product}}</p>
